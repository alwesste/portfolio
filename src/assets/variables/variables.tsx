export const presentation : string = `Après avoir passé quatre années à l'étranger, j'ai décidé de me reconvertir 
dans un domaine qui me passionne : "le développement web". Pour cela, j'ai passé une certification RNCP de niveau 
5 chez OpenClassrooms. Au cours de ma formation, j'ai acquis une solide expertise dans un éventail de 
technologies essentielles pour le développement front-end. J'ai développé des compétences en JavaScript, 
TypeScript, React, Vue, Redux, HTML5, CSS3, Sass et l'optimisation web. Ma connaissance du référencement (SEO) 
et mon expérience dans l'optimisation de sites web garantissent que les projets que je touche sont non seulement 
visuellement attrayants, mais aussi performants sur les moteurs de recherche. Je suis adepte des méthodes agiles, 
ce qui signifie que je suis flexible, réactif et axé sur la collaboration. Je suis à l'aise dans l'environnement 
Node.js et je peux intégrer des fonctionnalités côté serveur dans mes applications front-end. Cela me permet de 
créer des applications web robustes et évolutives.`
