    ...
    return (
        <>
            <div className={`footer ${isDarkMode && 'darkmode'}`}>
                <p>Mady with 
                    <img className="footer-logo" src={`http://52.70.43.187:1337${viteUrl}`} alt="logo of vite" />
                    and hosted on 
                    <img className="footer-logo" src={`http://52.70.43.187.113:1337${awsUrl}`} alt="logo of AWS" />
                </p>
            </div>
        </>
    )
