                    ...
                    {cardsData.map((card, index) => (
                        <div className={`card ${index % 2 === 0 ? "card-even" : "card-odd"}`} key={index}>
                            <img className={`card-Img ${isDarkMode ? 'low-box-shadow' : ''}`}
                                src={`https://portfolio-leopold.vercel.app:1337${card.attributes.image.data[0].attributes.url}`} 
                                alt={`Card ${index}`} />
                        <div className={`card-text ${isDarkMode ? 'light-text' : 'dark-text'}`}>
                                ...
                                <div className={`card-logo-container${index}`}>
                                    ...
                                    <img
                                        key={logoIndex}
                                        className='logo'
                                        src={`https://portfolio-leopold.vercel.app:1337${logo.attributes.url}`}
                                        alt={`Logo ${logoIndex}`}
                                    />
                                ))}
                                </div>
